      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
          ...
          <a
            ...
            className="block w-full max-w-3xl bg-green-600/80 hover:bg-green-700/90 border border-green-800 hover:shadow-lg text-white text-lg p-6 rounded-md shadow-md transition-all"
          >
      ...
      <section className="py-16 container mx-auto px-4 bg-green-50 rounded-lg">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full bg-green-600/80 hover:bg-green-700/90 border border-green-800 hover:shadow-lg text-white text-lg p-6 rounded-md shadow-md transition-all"
          >
            Ed Udale potato field orthomosaic map – 19th May 2025 – Apley, Telford
          </a>
        </div>
