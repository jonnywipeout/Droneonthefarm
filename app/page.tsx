    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-slate-100">
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="border border-green-300 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
          ...
          <Card className="border border-green-300 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600 text-center">
                Detailed aerial reports and documentation for construction and agricultural engineering projects
              </p>
              <p className="text-green-700 text-center text-sm font-medium italic mt-2">
          ...
          <Card className="border border-green-300 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600 text-center mb-3">
                High-resolution orthomosaic maps and 3D models for enhanced spatial insights and planning
              </p>
