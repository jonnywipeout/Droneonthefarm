      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
          ...
          <a
            ...
            className="block w-full max-w-3xl bg-green-600/70 hover:bg-green-700/80 border border-green-800 hover:shadow-2xl text-black text-lg p-6 rounded-md shadow-lg transition-all font-semibold italic"
          >
